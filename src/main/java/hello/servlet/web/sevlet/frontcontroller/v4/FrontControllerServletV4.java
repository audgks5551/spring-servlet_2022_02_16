package hello.servlet.web.sevlet.frontcontroller.v4;
...
import hello.servlet.web.sevlet.frontcontroller.v4.controller.MemberFormControllerV4;
import hello.servlet.web.sevlet.frontcontroller.v4.controller.MemberListControllerV4;
import hello.servlet.web.sevlet.frontcontroller.v4.controller.MemberSaveControllerV4;
...
public class FrontControllerServletV4 extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ControllerV4 controller = controllerMap.get(requestURI); // 필요한 컨트롤러 찾기
